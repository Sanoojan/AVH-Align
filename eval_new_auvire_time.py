...
def compute_test_style_segment_metrics(framewise_labels, proposal_segments, metrics_device):
    ...
    for proposals in proposal_segments:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--proposal_confidence_threshold", type=float, default=0.5, help="Only used for framewise plots; segment AP/AR uses ranked soft-NMS proposals like auvire/scripts/test.py.")
